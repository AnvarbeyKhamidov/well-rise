  ...
  return (
    <>
            ...
            <div className="burs_footer">
                ...
                <div className="burs_header">
                <section>
                    <p>Бурсаплекс (Bursaplex) - вакцины против инфекционной бурсальной болезни</p>
                    <h3>Lorem ipsum dolor, sit amet consectetur adipisicing elit. Minus temporibus ad tempora aliquid excepturi officia odit dolores a distinctio consectetur accusantium aut veritatis itaque, consequatur quidem expedita totam maiores facere?</h3>
                    <a href="tel: 99 999 99 99">СВЯЗАТЬСЯ С НАМИ</a>
                </section>
                <img className="mers" src="./imgs/bursaplex.png" alt="" />
                </div>
